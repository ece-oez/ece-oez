...
- 💼 Working on a **Parking Management System**
  - TypeScript · Angular · C# · .NET · MQTT
...
- 👾 Create small games & prototypes
- 🍜 Cook & enjoy good food
...
- Clean architecture mindset 🏗️
- Design patterns awareness 🧩
- Full-stack capable
- Uses Copilot & agentic tools when helpful 🤖
...
- 🅿️ Parking Management System (Angular + .NET)
- 🎬 Movie API (PHP + Docker + REST)
